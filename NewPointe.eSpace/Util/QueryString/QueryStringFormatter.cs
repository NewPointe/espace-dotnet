            ...
            using (var stream = new StreamWriter(serializationStream))
            {
                ...
                else
                {
                    ...
                    foreach (PropertyInfo prop in properties)
                    {
                        ...
                        QueryStringPropertyAttribute keyAttribute = prop.GetCustomAttribute<QueryStringPropertyAttribute>(true);
                        string queryStringKey = keyAttribute != null ? keyAttribute.QueryStringKey : prop.Name;
